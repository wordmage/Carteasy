 ...
 */
public class CompoundCart extends LinearLayout {
    ...
    public CompoundCart(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void initializeViews(Context context) {
        ...
        inflater.inflate(R.layout.compoundcart, this);
    }
    ...
    public void setProductPriceColor(int color) {
        productPrice.setTextColor(color);
    }
